...
void _main(void)
{
  ...
  800087:	bb ac 22 80 00       	mov    $0x8022ac,%ebx
  ...
  8000aa:	68 9c 1f 80 00       	push   $0x801f9c
  ...
  800121:	68 c4 1f 80 00       	push   $0x801fc4
  ...
  800152:	68 14 20 80 00       	push   $0x802014
  ...
  800166:	68 68 20 80 00       	push   $0x802068
  ...
  80024c:	68 ae 20 80 00       	push   $0x8020ae
  ...
  80026a:	68 c7 20 80 00       	push   $0x8020c7
  ...
  80028a:	68 c7 20 80 00       	push   $0x8020c7
  ...
  80029e:	68 d4 20 80 00       	push   $0x8020d4
  ...
  8002cf:	68 14 20 80 00       	push   $0x802014
  ...
  8002e3:	68 30 21 80 00       	push   $0x802130
  ...
  8002ff:	68 60 21 80 00       	push   $0x802160
  ...
  800335:	68 cc 21 80 00       	push   $0x8021cc
  ...
  800349:	68 4c 22 80 00       	push   $0x80224c
...
libmain(int argc, char **argv)
{
  ...
  8003e4:	bb b8 23 80 00       	mov    $0x8023b8,%ebx
  ...
  800429:	68 d8 22 80 00       	push   $0x8022d8
  ...
  800445:	50                   	push   %eax
  800446:	68 00 23 80 00       	push   $0x802300
  ...
  80046e:	52                   	push   %edx
  80046f:	50                   	push   %eax
  800470:	68 24 23 80 00       	push   $0x802324
  ...
  80049f:	52                   	push   %edx
  8004a0:	50                   	push   %eax
  8004a1:	68 4c 23 80 00       	push   $0x80234c
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800531:	50                   	push   %eax
  800532:	68 1c 24 80 00       	push   $0x80241c
  ...
  80054d:	50                   	push   %eax
  80054e:	68 24 24 80 00       	push   $0x802424
  ...
  800574:	68 4c 24 80 00       	push   $0x80244c
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8005a4:	68 50 24 80 00       	push   $0x802450
  8005a9:	6a 26                	push   $0x26
  8005ab:	68 9c 24 80 00       	push   $0x80249c
  ...
  80068d:	68 a8 24 80 00       	push   $0x8024a8
  800692:	6a 3a                	push   $0x3a
  800694:	68 9c 24 80 00       	push   $0x80249c
  ...
  800708:	68 fc 24 80 00       	push   $0x8024fc
  80070d:	6a 44                	push   $0x44
  80070f:	68 9c 24 80 00       	push   $0x80249c
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800939:	05 74 27 80 00       	add    $0x802774,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800a8c:	8b 04 85 98 27 80 00 	mov    0x802798(,%eax,4),%eax
  ...
  800b6d:	8b 34 9d e0 25 80 00 	mov    0x8025e0(,%ebx,4),%esi
  800b74:	85 f6                	test   %esi,%esi
  800b76:	75 19                	jne    800b91 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  800b78:	53                   	push   %ebx
  800b79:	68 85 27 80 00       	push   $0x802785
  ...
  800b8c:	e9 5b 02 00 00       	jmp    800dec <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800b91:	56                   	push   %esi
  800b92:	68 8e 27 80 00       	push   $0x80278e
  ...
  800bbd:	75 05                	jne    800bc4 <vprintfmt+0x1a6>
				p = "(null)";
  800bbf:	be 91 27 80 00       	mov    $0x802791,%esi
			if (width > 0 && padc != '-')
