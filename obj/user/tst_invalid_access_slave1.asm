...
libmain(int argc, char **argv)
{
  ...
  8000ea:	bb 8c 1d 80 00       	mov    $0x801d8c,%ebx
  ...
  80012f:	68 ac 1c 80 00       	push   $0x801cac
  ...
  80014b:	50                   	push   %eax
  80014c:	68 d4 1c 80 00       	push   $0x801cd4
  ...
  800174:	52                   	push   %edx
  800175:	50                   	push   %eax
  800176:	68 f8 1c 80 00       	push   $0x801cf8
  ...
  8001a5:	52                   	push   %edx
  8001a6:	50                   	push   %eax
  8001a7:	68 20 1d 80 00       	push   $0x801d20
  ...
  8001c2:	50                   	push   %eax
  8001c3:	68 78 1d 80 00       	push   $0x801d78
  8001c8:	e8 38 03 00 00       	call   800505 <cprintf>
  8001cd:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  8001d0:	83 ec 0c             	sub    $0xc,%esp
  8001d3:	68 ac 1c 80 00       	push   $0x801cac
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  800237:	50                   	push   %eax
  800238:	68 f0 1d 80 00       	push   $0x801df0
  ...
  800253:	50                   	push   %eax
  800254:	68 f8 1d 80 00       	push   $0x801df8
  ...
  80027a:	68 20 1e 80 00       	push   $0x801e20
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  8002aa:	68 24 1e 80 00       	push   $0x801e24
  8002af:	6a 26                	push   $0x26
  8002b1:	68 70 1e 80 00       	push   $0x801e70
  ...
  80040e:	68 d0 1e 80 00       	push   $0x801ed0
  800413:	6a 44                	push   $0x44
  800415:	68 70 1e 80 00       	push   $0x801e70
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  80063f:	05 34 21 80 00       	add    $0x802134,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800792:	8b 04 85 58 21 80 00 	mov    0x802158(,%eax,4),%eax
  ...
  800873:	8b 34 9d a0 1f 80 00 	mov    0x801fa0(,%ebx,4),%esi
  80087a:	85 f6                	test   %esi,%esi
  80087c:	75 19                	jne    800897 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  80087e:	53                   	push   %ebx
  80087f:	68 45 21 80 00       	push   $0x802145
  ...
  800892:	e9 5b 02 00 00       	jmp    800af2 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800897:	56                   	push   %esi
  800898:	68 4e 21 80 00       	push   $0x80214e
  ...
  8008c3:	75 05                	jne    8008ca <vprintfmt+0x1a6>
				p = "(null)";
  8008c5:	be 51 21 80 00       	mov    $0x802151,%esi
			if (width > 0 && padc != '-')
