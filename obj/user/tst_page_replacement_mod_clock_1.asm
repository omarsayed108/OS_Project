...
void _main(void)
{
  ...
  8000c3:	68 1c 1e 80 00       	push   $0x801e1c
  ...
  8000e1:	68 35 1e 80 00       	push   $0x801e35
  ...
  800101:	68 35 1e 80 00       	push   $0x801e35
  ...
  800115:	68 44 1e 80 00       	push   $0x801e44
  ...
  800146:	68 74 1e 80 00       	push   $0x801e74
  ...
  8001b1:	68 f0 1e 80 00       	push   $0x801ef0
  ...
  8001c5:	68 30 1f 80 00       	push   $0x801f30
...
libmain(int argc, char **argv)
{
  ...
  80025a:	bb 88 20 80 00       	mov    $0x802088,%ebx
  ...
  80029f:	68 a8 1f 80 00       	push   $0x801fa8
  ...
  8002bb:	50                   	push   %eax
  8002bc:	68 d0 1f 80 00       	push   $0x801fd0
  ...
  8002e4:	52                   	push   %edx
  8002e5:	50                   	push   %eax
  8002e6:	68 f4 1f 80 00       	push   $0x801ff4
  ...
  800315:	52                   	push   %edx
  800316:	50                   	push   %eax
  800317:	68 1c 20 80 00       	push   $0x80201c
  ...
  800332:	50                   	push   %eax
  800333:	68 74 20 80 00       	push   $0x802074
  800338:	e8 38 03 00 00       	call   800675 <cprintf>
  80033d:	83 c4 10             	add    $0x10,%esp
			cprintf("**************************************\n");
  800340:	83 ec 0c             	sub    $0xc,%esp
  800343:	68 a8 1f 80 00       	push   $0x801fa8
...
_panic(const char *file, int line, const char *fmt,...)
{
  ...
  8003a7:	50                   	push   %eax
  8003a8:	68 ec 20 80 00       	push   $0x8020ec
  ...
  8003c3:	50                   	push   %eax
  8003c4:	68 f4 20 80 00       	push   $0x8020f4
  ...
  8003ea:	68 1c 21 80 00       	push   $0x80211c
...
void CheckWSArrayWithoutLastIndex(uint32 *expectedPages, int arraySize)
{
  ...
  80041a:	68 20 21 80 00       	push   $0x802120
  80041f:	6a 26                	push   $0x26
  800421:	68 6c 21 80 00       	push   $0x80216c
  ...
  800503:	68 78 21 80 00       	push   $0x802178
  800508:	6a 3a                	push   $0x3a
  80050a:	68 6c 21 80 00       	push   $0x80216c
  ...
  80057e:	68 cc 21 80 00       	push   $0x8021cc
  800583:	6a 44                	push   $0x44
  800585:	68 6c 21 80 00       	push   $0x80216c
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8007af:	05 34 24 80 00       	add    $0x802434,%eax
...
vprintfmt(void (*putch)(int, void*), void *putdat, const char *fmt, va_list ap)
{
  ...
  800902:	8b 04 85 58 24 80 00 	mov    0x802458(,%eax,4),%eax
  ...
  8009e3:	8b 34 9d a0 22 80 00 	mov    0x8022a0(,%ebx,4),%esi
  8009ea:	85 f6                	test   %esi,%esi
  8009ec:	75 19                	jne    800a07 <vprintfmt+0x173>
				printfmt(putch, putdat, "error %d", err);
  8009ee:	53                   	push   %ebx
  8009ef:	68 45 24 80 00       	push   $0x802445
  ...
  800a02:	e9 5b 02 00 00       	jmp    800c62 <vprintfmt+0x3ce>
			...
			if (err > MAXERROR || (p = error_string[err]) == NULL)
				...
				printfmt(putch, putdat, "%s", p);
  800a07:	56                   	push   %esi
  800a08:	68 4e 24 80 00       	push   $0x80244e
  ...
  800a33:	75 05                	jne    800a3a <vprintfmt+0x1a6>
				p = "(null)";
  800a35:	be 51 24 80 00       	mov    $0x802451,%esi
			if (width > 0 && padc != '-')
